...
|----------|---------|---------|---------|---------|
| **`channelId`** | `UCtQMmwBJGvINGU0lZ_GrZKQ` |  | The `channelId` parameter indicates that the API response should only contain resources created by the channel<br>Username to Channel ID Converter: http://kid.yt.j.pfweb.eu/<br>Username to Channel ID on stackoverflow: http://stackoverflow.com/a/14378955/878055 | no |
